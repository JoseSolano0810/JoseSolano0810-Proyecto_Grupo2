        ...
        <div class="pagina activa" id="pagina-inicio">
            ...
            <div class="kpi-grid">
                <div class="kpi-card">
                    ...
                    <div><div class="kpi-numero"><?= count($citas) ?></div><div class="kpi-etiqueta">Citas hoy</div></div>
                </div>
                <div class="kpi-card">
                    <div class="kpi-icono verde"><i class="bi bi-people"></i></div>
                    <div><div class="kpi-numero"><?= count($pacientes) ?></div><div class="kpi-etiqueta">Pacientes activos</div></div>
                </div>
                <div class="kpi-card">
                    <div class="kpi-icono amarillo"><i class="bi bi-clipboard2-pulse"></i></div>
                    <div><div class="kpi-numero"><?= count($tratamientos) ?></div><div class="kpi-etiqueta">Tratamientos en curso</div></div>
                </div>
                <div class="kpi-card">
                    <div class="kpi-icono rojo"><i class="bi bi-exclamation-circle"></i></div>
                    <div><div class="kpi-numero">2</div><div class="kpi-etiqueta">Pendientes de revisión</div></div>
                </div>
            </div>
            ...
            <div class="panel-grid col-3">
                ...
                <div class="tarjeta">
                    <div class="panel-titulo"><h3>Tratamientos activos</h3></div>
        ...
        <div class="pagina" id="pagina-agenda">
            ...
            <div class="tarjeta">
                <table class="tabla-odent">
                    <thead><tr><th>Hora</th><th>Paciente</th><th>Tratamiento</th><th>Estado</th><th>Acciones</th></tr></thead>
                    <tbody>
                        <?php foreach ($citas as $cita): ?>
                        <tr>
        ...
        <div class="pagina" id="pagina-expedientes">
            <div class="panel-titulo" style="margin-bottom:20px;">
                ...
                <div style="display:flex;gap:10px;">
                    <input type="text" placeholder="Buscar paciente..." style="border:1.5px solid var(--borde);border-radius:8px;padding:8px 14px;font-size:14px;min-width:220px;">
                    <button class="btn-odent"><i class="bi bi-search"></i> Buscar</button>
                </div>
            </div>
            <div class="tarjeta">
                <table class="tabla-odent">
                    <thead><tr><th>N.°</th><th>Paciente</th><th>Cédula</th><th>Edad</th><th>Última visita</th><th>Estado</th><th>Acciones</th></tr></thead>
                    <tbody>
            ...
            <div class="panel-grid col-2">
                <div class="odontograma-container">
                    ...
                    <div class="leyenda-odontograma">
                        <div class="leyenda-item"><div class="leyenda-color" style="background:#fff;border-color:var(--borde);"></div> Sano</div>
                        <div class="leyenda-item"><div class="leyenda-color" style="background:rgba(192,57,43,.2);border-color:#C0392B;"></div> Caries</div>
                        <div class="leyenda-item"><div class="leyenda-color" style="background:rgba(245,158,11,.2);border-color:#f59e0b;"></div> Corona</div>
                        <div class="leyenda-item"><div class="leyenda-color" style="background:var(--fondo-odent);border-color:var(--gris-azulado);"></div> Ausente</div>
                    </div>
                </div>
                <div class="tarjeta">
            ...
            <div class="panel-grid col-2">
                ...
                <div class="tarjeta">
                    ...
                    <div class="tratamiento-item">
                        ...
                        <div class="barra-progreso" style="margin-bottom:12px;"><div class="barra-relleno" style="width:<?= $t['progreso'] ?>%;"></div></div>
                    </div>
...
<div class="modal-overlay" id="modal-nueva-cita">
    <div class="modal-caja">
        ...
        <div class="campo-grupo"><label>Tratamiento</label>
            <select><option>Limpieza dental</option><option>Extracción</option><option>Ortodoncia</option><option>Blanqueamiento</option><option>Revisión general</option></select>
        </div>
