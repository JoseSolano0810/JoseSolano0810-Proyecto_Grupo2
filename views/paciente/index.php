...
$mis_tratamientos = [
    ...
    ['nombre'=>'Limpieza semestral','progreso'=>100,'inicio'=>'28/07/2026','sesiones_total'=>1,'sesiones_realizadas'=>1,'estado'=>'completada'],
];

$mis_pagos = [
    ['id'=>'PAG-001','fecha'=>'28/07/2026','concepto'=>'Limpieza dental','monto'=>50000,'metodo'=>'Tarjeta','estado'=>'completada'],
    ['id'=>'PAG-003','fecha'=>'03/08/2026','concepto'=>'Cuota ortodoncia 8/12','monto'=>60000,'metodo'=>'Sinpe','estado'=>'pendiente'],
];
    ...
    <div class="contenido-principal">
        ...
        <div class="pagina activa" id="pagina-inicio">
            ...
            <div class="paciente-bienvenida">
                <div>
                    <span class="etiqueta-odent" style="color:rgba(255,255,255,.7);">BIENVENIDA</span>
                    <h2>¡Hola, <?= htmlspecialchars($usuario['nombre']) ?>!</h2>
                    <p>Aquí puedes consultar tus citas, tratamientos y pagos.</p>
                </div>
            ...
            <div class="panel-grid col-3">
                ...
                <div style="display:flex;flex-direction:column;gap:18px;">
                    ...
                    <div class="tarjeta">
                        ...
                        <div class="proxima-cita">
                            <div class="proxima-cita-fecha">
                                ...
                                <div class="dia"><?= $proxima_cita['dia'] ?></div>
                            </div>
                    ...
                    <div class="tarjeta">
                        <h3 style="margin-bottom:14px;">Saldo pendiente</h3>
                        <?php if($saldo_pendiente > 0): ?>
                        <div class="saldo-card">
                            <div class="saldo-monto">₡<?= number_format($saldo_pendiente,0,',','.') ?></div>
                            <p style="font-size:13px;color:#856404;margin-top:6px;">Cuota de ortodoncia pendiente</p>
                        </div>
                        ...
                        <?php else: ?>
                        <div class="alerta exito"><i class="bi bi-check-circle"></i> No tiene saldos pendientes.</div>
                        <?php endif; ?>
                    </div>
                ...
                <div class="tarjeta">
                    ...
                    <div class="tratamiento-item">
                        ...
                        <div style="font-size:12px;color:var(--gris-azulado);margin-bottom:6px;">
                            <?= $t['sesiones_realizadas'] ?> de <?= $t['sesiones_total'] ?> sesiones
                            — Inicio: <?= $t['inicio'] ?>
                        </div>
                        <div class="barra-progreso">
                            <div class="barra-relleno" style="width:<?= $t['progreso'] ?>%;"></div>
                        </div>
                        <span class="badge-estado badge-<?= $t['estado'] ?>" style="margin-top:8px;display:inline-block;">
        ...
        <div class="pagina" id="pagina-tratamientos">
            <h2 style="margin-bottom:20px;">Mis tratamientos</h2>
            <div class="panel-grid col-2">
                ...
                <div class="tarjeta">
                    ...
                    <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;font-size:13px;color:var(--gris-azulado);margin-bottom:14px;">
                        <div><strong style="color:var(--gris-texto);">Inicio</strong><br><?= $t['inicio'] ?></div>
                        <div><strong style="color:var(--gris-texto);">Sesiones</strong><br><?= $t['sesiones_realizadas'] ?> / <?= $t['sesiones_total'] ?></div>
                    </div>
                    <div class="tratamiento-header">
        ...
        <div class="pagina" id="pagina-pagos">
            <h2 style="margin-bottom:20px;">Mis pagos</h2>
            <?php if($saldo_pendiente > 0): ?>
            <div class="alerta aviso">
                <i class="bi bi-exclamation-triangle"></i>
                Tiene un saldo pendiente de <strong>₡<?= number_format($saldo_pendiente,0,',','.') ?></strong>.
            ...
            <div class="tarjeta">
                <table class="tabla-odent">
                    <thead>
                        <tr><th>ID</th><th>Fecha</th><th>Concepto</th><th>Monto</th><th>Método</th><th>Estado</th></tr>
                    </thead>
                    <tbody>
        ...
        <div class="pagina" id="pagina-asistente">
            <h2 style="margin-bottom:6px;">Asistente de triaje</h2>
            ...
            <div class="panel-grid col-3">
                    ...
                    <div class="asistente-chat">
                        <div class="chat-mensajes" id="chat-mensajes">
                            <div class="mensaje bot">
                                Hola <strong><?= htmlspecialchars($usuario['nombre']) ?></strong>, soy el asistente de triaje de Odent.
                        ...
                        <div class="chat-input">
                            <input type="text" id="chat-input-texto" placeholder="Escriba su consulta o síntoma..." onkeydown="chatEnter(event)">
                ...
                <div class="tarjeta">
                    <h4 style="margin-bottom:14px;">Preguntas frecuentes</h4>
                    <div style="display:flex;flex-direction:column;gap:8px;">
                        ...
                        <button onclick="preguntaRapida('<?= htmlspecialchars($preg, ENT_QUOTES) ?>')"
                            ...
                            <i class="bi bi-chat-dots" style="color:var(--verde-odent);"></i>
